...
export type SharePayload = { images: string[] };
...
onmessage = async (e) => {
    ...
    const completedResponse = responses.find(result => result.status === 'fulfilled') as PromiseFulfilledResult<ImageBitmap> | undefined;
